...
### Безпека
- Використовується AES-256-GCM (Galois/Counter Mode) для нових шифрувань
  - Автентифіковане шифрування (AEAD) для одночасного захисту конфіденційності та цілісності
  - Захист від атак підробки та модифікації даних
  - Підтримка зворотної сумісності зі старим форматом (AES-256-CBC + HMAC-SHA512)
- PBKDF2 з 600,000 ітераціями та SHA-512 для безпечної генерації ключа
- Криптографічно безпечний генератор випадкових чисел для солі та nonce
- Безпечне очищення чутливих даних з пам'яті
- Захист від часових атак через константний час порівняння
